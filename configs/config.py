...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', default='kitti_tracking',
                                 help='only support kitti tracking dataset yet')
        ...
        self.parser.add_argument('--arch', default='dla_34',
                                 help='model architecture. only support dla34 yet')
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        # head_conv: 256
        # head: [256]
        opt.head_conv = {head: [opt.head_conv for i in range(opt.num_head_conv if head != 'reg' else 1)] for head in
                         opt.heads}
